...
async function testSvgNamespaceRendering() {
    ...
    try {
        ...
        assert.strictEqual(renderedSvg.namespaceURI, 'http://www.w3.org/2000/svg', 'SVG element should be in SVG namespace');
        ...
        assert.strictEqual(renderedCircle.namespaceURI, 'http://www.w3.org/2000/svg', 'Circle element should be in SVG namespace');
